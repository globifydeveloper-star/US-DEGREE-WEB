...
const Navbar = () => {
  ...
  return (
    <nav className="h-[85.41px] bg-white sticky top-0 z-50 border-t-[4px] border-[#f0f2f5] shadow-sm flex justify-center">
      <div className="w-full max-w-[2380px] px-6 sm:px-10 lg:px-[86px] h-full flex items-center justify-between">
      ...
      {isMobileMenuOpen && (
        <div className="absolute top-[85.41px] left-0 w-full bg-white border-b border-[#f0f2f5] shadow-lg lg:hidden flex flex-col p-6 gap-6 text-[#4b5563] font-medium animate-in slide-in-from-top-2">

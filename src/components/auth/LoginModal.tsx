...
export default function LoginModal({ isOpen, initialMode = 'login', onClose, onSuccess }: LoginModalProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className="w-full max-w-[480px] bg-white rounded-[32px] border border-gray-100 shadow-2xl p-6 md:p-8 relative overflow-hidden animate-scale-up select-none font-['Poppins']"
      >
        ...
        <div className="mb-5 text-center">
          ...
          <p className="text-xs font-semibold text-slate-400">
            {mode === 'login' ? 'Sign in to save your universities & details.' : 'Join us to discover your path to a US degree.'}
          </p>
        </div>
            ...
            <>
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <div className="space-y-1">
                  <label htmlFor="name-field" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider pl-1">Full Name</label>
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <div className="space-y-1">
                  <label htmlFor="password-field" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider pl-1">Password</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                ...
                <div className="space-y-1">
                  <label htmlFor="confirm-password-field" className="text-[11px] font-bold text-slate-500 uppercase tracking-wider pl-1">Confirm</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                      <Lock className="w-4 h-4" />
                    </div>

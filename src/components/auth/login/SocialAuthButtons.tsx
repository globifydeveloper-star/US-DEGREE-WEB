    ...
    <>
      <div className="grid grid-cols-2 gap-2 sm:gap-3 mb-5">
        <button
          ...
          className="flex items-center justify-center gap-2 px-3 py-2.5 border border-slate-200 rounded-xl hover:bg-slate-50 active:scale-98 transition-all text-xs sm:text-sm font-bold text-slate-600 cursor-pointer"
        >

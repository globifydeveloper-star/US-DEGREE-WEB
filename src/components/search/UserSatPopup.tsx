...
export default function UserSatPopup({ setShowModal, tempGpa, setTempGpa, validateGpa, gpaError, tempSat, setTempSat, validateSat, satError, university, admissionRate, satAct, hasSatData, isCalculated, handleClear, handleCalculate }: any) {

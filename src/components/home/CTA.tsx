  ...
  return (
    <section className="px-6 sm:px-10 lg:px-[86px] py-12 flex justify-center">
      <div className="w-full max-w-[2380px] bg-[#edf2ff] rounded-[2rem] flex flex-col md:flex-row items-center overflow-hidden min-h-[400px]">
        {/* Left Content */}
        <div className="flex-1 min-w-0 p-8 sm:p-10 md:p-10 lg:p-16 flex flex-col justify-center order-2 md:order-1">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap gap-4">
            <button
              ...
              className="w-full lg:w-auto text-center bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-semibold transition-colors cursor-pointer"
            >
              Get Started Now
            </button>
            <Link
              href="/compare"
              className="w-full lg:w-auto text-center bg-white hover:bg-gray-50 text-blue-600 px-8 py-3 rounded-full font-semibold transition-colors shadow-sm"
            >
              Compare Programs
            </Link>
          </div>
        ...
        {/* Right Image */}
        <div className="w-full md:flex-1 min-w-0 order-1 md:order-2 p-6 md:p-6 lg:p-10">
